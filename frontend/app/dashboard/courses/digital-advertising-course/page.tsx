...
export default function DigitalAdvertisingCoursePage() {
  ...
  const steps = [
      ...
      lectures: [
        {
          ...
          problems: [
            ...
            {
              id: 2,
              title: "Digital Advertising Channels Overview",
              status: "pending",
              difficulty: "Basic",
              hasSolution: true,
              hasDoc: true,
            ...
            {
              id: 4,
              title: "Digital Advertising Metrics",
              status: "pending",
            ...
            {
              id: 5,
              title: "Ad Targeting and Audience Segmentation",
              status: "pending",
              difficulty: "Intermediate",
              hasSolution: true,
              hasDoc: true,
    ...
    {
      id: 4,
      title: "Display and Programmatic Advertising",
      progress: "0/3",
      progressPercent: 0,
      lectures: [],
    },
    ...
    {
      id: 6,
      title: "Ad Campaign Management and Optimization",
      progress: "0/4",
      progressPercent: 0,
      lectures: [],
    },
    {
      id: 7,
      title: "Advanced Digital Advertising Strategies",
      progress: "0/3",
      progressPercent: 0,
      lectures: [],
    },
  ...
  return (
    <div className="max-w-6xl mx-auto bg-gray-100 min-h-screen pb-10">
      ...
      <div className="px-6">
        ...
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-2">Digital Advertising</h1>
          <p className="text-gray-600 mb-4">
            Master the art and science of digital advertising across multiple platforms to drive engagement and
            conversions.
          ...
          <div className="bg-purple-50 border border-purple-200 p-4 rounded-md mb-6">
            <p className="font-medium text-purple-800 mb-2">Course Overview:</p>
            <p className="text-gray-700">
              This comprehensive course covers all aspects of digital advertising, from fundamentals to advanced
              strategies. You'll learn how to create, manage, and optimize ad campaigns across search engines, social
              media, display networks, and video platforms to achieve maximum ROI.
            </p>
            <p className="text-gray-700 mt-2">
              Ideal for marketing professionals, business owners, and anyone looking to master digital advertising
              skills in today's competitive landscape.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center mb-6">
            <div className="flex items-center mb-4 md:mb-0 md:mr-8">
              <div className="relative w-24 h-24 mr-4">
                ...
                <div
                  className="absolute inset-0 rounded-full border-4 border-purple-500 transition-all duration-500"
                  style={{
            ...
            <div className="flex space-x-2 mb-4">
              <button
                className={`px-4 py-2 rounded-full font-medium ${
                  activeTab === "all" ? "bg-purple-100 text-purple-600" : "bg-white border text-gray-700"
                }`}
              ...
              <button
                className={`px-4 py-2 rounded-full font-medium ${
                  activeTab === "revision" ? "bg-purple-100 text-purple-600" : "bg-white border text-gray-700"
                }`}
                                  ...
                                  <tr key={problem.id}>
                                    <td className="px-4 py-3 whitespace-nowrap">
                                      {problem.status === "completed" ? (
                                        <div className="flex justify-center">
                                          <div className="h-6 w-6 rounded-md bg-purple-100 flex items-center justify-center text-purple-500">
                                            <svg
